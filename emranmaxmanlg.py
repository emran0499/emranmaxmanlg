...
print("\033[0;91mThis Tool's Free By Emran cyber")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Emran cyber'
    print '\033[0;94mFACEBOOK : Termux teacher Emran'
    print '\033[0;96mGITHUB   : TermuxEmran'
    print ''
